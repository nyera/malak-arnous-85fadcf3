...
export const testimonials: Testimonial[] = [
  ...
  { image: t38.url, instagramUrl: brand.instagram, alt: "شهادة عميلة من إنستجرام" },
  { image: t39.url, instagramUrl: brand.instagram, alt: "شهادة عميلة من إنستجرام" },
  { image: t40.url, instagramUrl: brand.instagram, alt: "شهادة عميلة من إنستجرام" },
  { image: t41.url, instagramUrl: brand.instagram, alt: "شهادة عميلة من إنستجرام" },
  { image: t42.url, instagramUrl: brand.instagram, alt: "شهادة عميلة من إنستجرام" },
  { image: t43.url, instagramUrl: brand.instagram, alt: "شهادة عميلة من إنستجرام" },
  { image: t44.url, instagramUrl: brand.instagram, alt: "شهادة عميلة من إنستجرام" },
